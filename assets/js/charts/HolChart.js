...
(function(){
    ...
    xAxis : [
        {
            type : 'category',
            data : ['4.25', '4.26', '4.27', '4.28', '4.29', '4.30', '5.1', '5.2', '5.3', '5.4','5.5', '5.6','5.7','5.8','5.9','5.10'],
            axisTick: {
                alignWithLabel: true
            }
        }
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[11967.77, 12603.43, 13241.36, 11785.02, 11561.23, 11660.93, 12135.34, 12187.34, 12377.82, 11975.99, 11411.25, 11431.03, 11605.23, 11573.54, 11279.23, 12256.74]
        }
    ]
};
...
(function(){
	...
	var myChart = echarts.init(document.getElementById("Guoqing"));
        var option = {
    color: ['#3398DB'],
    tooltip : {
        trigger: 'axis',
    ...
    xAxis : [
        {
            type : 'category',
            data : [ '9.26', '9.27', '9.28', '9.29', '9.30','9.31', '10.1', '10.2', '10.3', '10.4','10.5', '10.6','10.7','10.8','10.9','10.10'],
            axisTick: {
                alignWithLabel: true
            }
        }
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[11201.87, 12264.97, 11917.64, 11910.01, 11065.97, 10989.15, 10414.36, 10368.53, 10457.25, 10679.27, 10940.02, 11456.64, 10757.64, 10790.14, 10782.26]
        }
    ]
};
...
(function(){
    ...
    xAxis : [
        {
            type : 'category',
            data : [ '1.24', '1.25', '1.26', '1.27', '1.28','1.29', '1.30', '1.31', '2.1', '2.2','2.3', '2.4','2.5','2.6','2.7','2.8'],
            axisTick: {
                alignWithLabel: true
            }
        }
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[16547.92, 17112.99, 16489.75, 16280.74, 16590.93, 18379.35, 17686.48, 13857, 12834.66, 12919.13, 14581.62, 15369.46, 19143.26, 20924.73, 22318.19, 22311.51]
        }
    ]
};
	myChart.setOption(option);
